...
// 1.	Create a Car class that contains Maker ,  ModelYear fields
// 2.	Create an Agency class that contains Cars list fields,  GetEnumerator
//      GetCars methods to enable foreach iteration. GetCars can receive maker
//      or modelYear parameter that filters the returned cars
